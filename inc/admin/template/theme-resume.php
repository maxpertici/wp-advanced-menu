...
?>
<a data-fancybox href="#modal-<?php echo esc_html( $theme->theme_slug ) ; ?>" class="wpam-admin-theme" data-wpam-theme-style-url="<?php echo esc_url( $wpam_theme_style_url ) ; ?>">
    <h4 class="wpam-admin-theme-title"><?php echo esc_html( $theme->theme_name ); ?></h4>
    <p class="wpam-admin-theme-description"><?php echo esc_html( $theme->theme_description ); ?></p>
</a>

<div class="theme-modal" id="modal-<?php echo esc_html( $theme->theme_slug ) ; ?>">
    ...
    <div class="content-scroll">
        <p>
        <?php echo esc_html( $theme->theme_description ); ?>
        </p>
    </div>
</div>